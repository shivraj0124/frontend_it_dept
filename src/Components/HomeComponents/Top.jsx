...
function Top() {
  ...
  return (
    ...
    <>
      <div className='w-[100%]   bg-blue-50 h-[800px] max-md:h-screen max-md:h-[600px] flex flex-col justify-center items-center' >
        <div className='px-[10%]'>
          ...
          <div className='flex md:flex-row-reverse flex-col-reverse justify-center items-center z-10 max-md:gap-y-16 max-md:pt-5' >
            <div className='h-[100%] w-[100%]'>
              ...
              <div className='' id="lottie-container" />
            </div>
            <div className='flex flex-col text-center justify-center items-center w-[100%] h-[100%]'>
              ...
              <div>
                <h1 className='text-3xl font-semibold text-[#0099ff] '>Government Polytechnic Mumbai</h1>
