    ...
    <div className='min-h-screen overflow-y-scroll pb-10 bg-blue-50'>
      <div className="w-100 mt-5 max-md:mt-2 justify-center max-xl:px-2 xl:px-36 ">
        <div className="w-[100%] flex md:flex-row- max-md:flex-col-reverse p-3 bg-white shadow-xl rounded-md">
          <div className='w-[100%] text-center mt-5 max-lg:mt-2 bg-white pb-5'>
            <h1 className='text-center font-semibold text-2xl underline underline-offset-4'>Add Faculty</h1>
            <form className='mt-10 max-lg:mt-4 text-black flex flex-col justify-center items-center' onSubmit={handleSubmit}>
              ...
              <label className='lg:w-[40%] border-blue-900 text-blue-900 font-semibold bg-blue-300 hover:bg-blue-600 hover:text-white py-[6px] px-[12px] inline-block cursor-pointer mt-5'>
                <input type="file" name="photo" className='hidden' onChange={handleFileChange} required />
                Upload Photo
              </label>
              <br />
              <button className='mt-10 max-lg:mt-4  w-[80%] bg-blue-800 rounded-lg py-2 text-xl text-white cursor-pointer hover:bg-blue-500'>
                Add Faculty
              </button>
            </form>
          </div>
