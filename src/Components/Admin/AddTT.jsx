...
function AddTT() {
    ...
    return (
        <div className='h-screen overflow-y-scroll pb-10 bg-blue-50'>
            <div className='w-100 mt-2 justify-center max-xl:px-2 xl:px-36 pb-10 max-md:mt-20'>
                <div className='w-[100%] flex md:flex-row- max-md:flex-col-reverse px-2 bg-white shadow-xl rounded-md'>
                    <div className='w-[100%] text-center  bg-white pb-10 mt-10 '>
                        ...
                        <form className='mt-2 text-black' onSubmit={handleOnSubmit}>
                            ...
                            <br />
                            <button className='mt-8 max-md:mt-5 w-[80%] bg-blue-800 rounded-lg py-2 text-xl text-white cursor-pointer hover:bg-blue-500'>
                                Add Time Table
                            </button>
                        </form>
                    </div>
                    <div className='w-[100%] h-[100%] max-xl:hidden max-md:mt-2'>
